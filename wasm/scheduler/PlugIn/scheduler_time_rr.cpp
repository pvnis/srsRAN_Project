...
// host functions
__attribute__((import_module("extern_module"), import_name("alloc_dl_grant")))
void alloc_dl_grant(__externref_t ue, __u32 cell_index, __u32 harq_id, __u32 ss_id, __u64 pdsch_td_res_index, __u32 ue_grant_crbs_start, __u32 ue_grant_crbs_end, __u32 aggr_lvl, __u32 mcs);

__attribute__((import_module("extern_module"), import_name("alloc_ul_grant")))
void alloc_ul_grant(__externref_t ue, __u32 cell_index, __u32 harq_id, __u32 ue_grant_crbs_start, __u32 ue_grant_crbs_end, __u32 symbols_start, __u32 symbols_end, __u64 pusch_td_res_index, __u32 ss_id, __u32 aggr_lvl, __u32 mcs);
...
extern "C" dl_sched(const ue_resource_grid_view& res_grid, const ue_repository& ues) {
...
extern "C" ul_sched(const ue_resource_grid_view& res_grid, const ue_repository& ues) {
  scheduler_time_rr::ul_sched(pdsch_alloc, res_grid, ues);
}
