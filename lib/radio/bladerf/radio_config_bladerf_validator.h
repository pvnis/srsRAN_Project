...
/// \brief Radio configuration validator for bladeRF based radios.
///
...
/// supported by the bladeRF device.
class radio_config_bladerf_config_validator : public radio_configuration::validator
{
public:
