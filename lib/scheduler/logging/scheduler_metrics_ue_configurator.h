...
public:
  ...
  /// Update UE to the reported metrics.
  virtual void handle_ue_update(du_ue_index_t ue_index, rnti_t rnti, s_nssai_t s_nssai, pci_t pcell_pci, unsigned num_prbs) = 0;
